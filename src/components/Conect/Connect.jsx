      ...
      <div className="w-full relative xl:h-screen min-h-[100vh] one bg-[#FAF6EF]">
        ...
        className="xl:hidden overflow-hidden  flex-col h-screen justify-between py-7 sm:hidden gap-5 flex ">
          <div className=" flex-col   gap-5 flex">
            <div className="flex items-center  pt-12 gap-3 tracking-tighter">
              ...
              <h1 className="  px-3 py-2  leading-none  text-3xl  rounded-full bg-[#F1EDE7]">
                to
              </h1>
              <h1 className="  px-3 py-2  leading-none  text-3xl   bg-[#F1EDE7]">
                chat
              </h1>
            </div>
            ...
            <div className="flex z-30">
              <h1 className=" px-3 py-2  leading-none  text-3xl rounded-full capitalize bg-[#FFD8F5]">
                Newbiz@Toyfight.co 😊
              </h1>
            </div>
          </div>
        ...
        <div className="flex sm:flex-col  xl:flex-row  sm:h-screen xl:h-1/2 items-start xl:items-center gap-2 xl:px-12 xl:justify-between sm:justify-around  text-[2.2vw]">
          ...
          className="xl:flex hidden overflow-hidden sm:flex z-20 flex-col gap-2">
            <div className="flex items-center pt-32 gap-2 tracking-tighter">
              ...
              <h1 className=" px-8  py-4  font-medium capitalize  bg-[#F1EDE7]">
                to
              </h1>
              <h1 className=" px-8  py-4   font-medium  capitalize rounded-full  bg-[#F1EDE7]">
                chat
              </h1>
              <h1 className=" px-8  py-4 font-medium capitalize bg-[#F1EDE7]">
                about
              </h1>
              <h1 className=" px-8  py-2  rounded-full capitalize bg-[#F1EDE7]">
                your
              </h1>
              <h1 className=" px-8  py-2  rounded-full capitalize bg-[#F1EDE7]">
                next
            ...
            <div className="flex">
              <h1 className=" px-8  py-2  rounded-full capitalize bg-[#FFD8F5]">
                Newbiz@Toyfight.co 😊
              </h1>
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="bg-[#FFD8F5] w-60 flex flex-col items-start px-5 py-3 gap-3 text-xs h-32">
            ...
            <h1>hwllow@toyfight.co</h1>
          </div>
          <div className="bg-[#FFD8F5] font-sans w-60 flex flex-col items-start px-5 py-3 gap-3 text-xs h-32">
            <h1 className="px-2 bg-white">Open Option</h1>
            <h1>Art Director</h1>
        ...
        <div className="xl:w-[32%] w-[100%] sm:w-[40%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <video
            ...
            src="https://res.cloudinary.com/durdzswls/video/upload/q_90/v1/spline-fallbacks/recorder-cropped.webm?_a=DATAdtAAZAA0"
          ></video>
        </div>
      </div>
    </>
